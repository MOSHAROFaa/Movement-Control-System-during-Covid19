...
session_start();
if (!isset($_SESSION['username']) || $_SESSION['role'] != "Academic Advisor") {
...
<h2>Our Brightest <?= $_SESSION['role'] ?> !!!</h2>
<br> <br> <br>

<body style="background-color: #8a2be2;">
  
  <a href="/Login_Diff_Users/AA/index.html"> <button>Go for MCS</button> </a>
